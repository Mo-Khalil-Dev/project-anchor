...
import type { AssessmentProps } from '../../domain/entities/assessment-props';
import type { AssessmentData } from '../../application/useCases/GetAssessmentQuery.dto';
import { AssessmentBreakdownParser } from '../../application/services/AssessmentBreakdownParser';
...
export class AssessmentMapper {
  ...
  toDomain(record: PrismaAssessment): Assessment {
    const props: AssessmentProps = {
      ...
      selectedPlan: record.selectedPlan ?? undefined,
